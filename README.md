...
2. Alternatively, you can click the button below to deploy directly.
   ...
   [![Deploy to Cloudflare Workers](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/wiwiwinarti784/EDtunnel)
